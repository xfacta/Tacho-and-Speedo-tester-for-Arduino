...
void loop() {
  ...
  if (micros() > Last_loop_time + Wait_Time)
  {
    ...
    if (vspeed < 60) vspeed = vspeed  + 5;
    else vspeed = vspeed  + 10;
    if (vspeed > 200) vspeed = 5;
    ...
    if (Debug_Mode)
    {
      ...
      Serial.print(Speed_Hz); Serial.println(" Hz");
      Serial.print(Speed_period); Serial.println(" us");
    }
    ...
    if (Debug_Mode)
    {
      ...
      Serial.print(RPM_Hz); Serial.println(" Hz");
      Serial.print(RPM_period); Serial.println(" us");
      Serial.println(" ");
    }
